...
cmake ../kodi-source -DCMAKE_INSTALL_PREFIX=/home/ark/kodi/bin-kodi -DENABLE_INTERNAL_DAV1D=ON -DENABLE_INTERNAL_PCRE=ON -DCORE_PLATFORM_NAME=gbm -DAPP_RENDER_SYSTEM=gles
if [ $? != 0 ]; then
  echo ""
